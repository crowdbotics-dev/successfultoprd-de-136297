"""
Django settings for successfultoprd_de_136297 project.
...
ROOT_URLCONF = 'successfultoprd_de_136297.urls'
...
WSGI_APPLICATION = 'successfultoprd_de_136297.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "successfultoprd Support <support@successfultoprd-de-136297.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "successfultoprd_de_136297 API",
    "DESCRIPTION": "API documentation for successfultoprd_de_136297 App",
    "VERSION": "v1",
}
